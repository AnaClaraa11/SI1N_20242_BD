...
VOO_DATAHORA_ORIGEM DATE NOT NULL,
VOO_DATAHORA_DESTINO DATE);

#CRIANDO A TABELINHA PRODUTOS
CREATE TABLE IF NOT EXISTS AEROPORTO(
AEROPORTO_COD INT PRIMARY KEY,
AEROPORTO_NOME VARCHAR(50) NOT NULL,
AEROPORTO_LOCAL TEXT NOT NULL,
AEROPORTO_PAIS TEXT NOT NULL,
AEROPORTO_LONGITUDE DECIMAL(10,3) NOT NULL,
AEROPORTO_LATITUDE DECIMAL(10,2) NOT NULL
);

CREATE TABLE IF NOT EXISTS  AERONAVES(
AERONAVE_COD INT PRIMARY KEY,
AERONAVE_ANOFABRICADO , 
AERONAVE_CAPACIDADE  , 
AERONAVE_FABRICANTE  )
